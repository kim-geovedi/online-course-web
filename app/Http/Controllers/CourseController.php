...
class CourseController extends Controller
{
    ...
    public function store(StoreCourseRequest $request)
    {
        ...
        if (!$teacher) {
            return redirect()->route('admin.courses.index')->withErrors(['error' => 'You are not a teacher']);
        }
    ...
    public function destroy(Course $course)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->route('admin.courses.index')->with('error','Course deletion failed');
        }
    }
}
